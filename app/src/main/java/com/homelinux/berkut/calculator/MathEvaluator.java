...
//    }
    ...
    public String getValue()
    {
    	...
    	try
        {
            ...
            Double res1= Double.parseDouble(String.valueOf(res.longValue()));
            if (res.equals(res1)) {
...
//        	e.printStackTrace();
    ...
    private static Double evaluateExpression(Operator o, Double f1, Double f2)
    {
        ...
        else if  ( "cos".equals(op) )  	res = new Double( Math.cos(Math.toRadians(f1.doubleValue())) );
        else if  ( "sin".equals(op) )  	res = new Double( Math.sin(Math.toRadians(f1.doubleValue())) );
        else if  ( "tan".equals(op) )  	res = new Double( Math.tan(Math.toRadians(f1.doubleValue())) );
        else if  ( "acos".equals(op) )  res = new Double( Math.toDegrees(Math.acos(f1.doubleValue())) );
        else if  ( "asin".equals(op) )  res = new Double(  Math.toDegrees(Math.asin(f1.doubleValue())) );
        else if  ( "atan".equals(op) )  res = new Double(  Math.toDegrees(Math.atan(f1.doubleValue())) );
